...
void load_datasets_and_labels(arma::mat &train_dataset, arma::Row<size_t>& train_labels, mlpack::data::DatasetInfo& info) {
    ...
    const std::string train_path = "/Users/edoardochiavazza/Desktop/unito-scpd/adaboost-mpi/datasets/covertype.train.arff";
    const std::string train_labels_path = "/Users/edoardochiavazza/Desktop/unito-scpd/adaboost-mpi/datasets/covertype.train.labels.csv";
...
void load_testData_and_labels(arma::mat& testDataset, arma::Row<size_t>& test_labels,  mlpack::data::DatasetInfo& info) {
    const std::string test_path = "/Users/edoardochiavazza/Desktop/unito-scpd/adaboost-mpi/datasets/covertype.test.arff";
    const std::string test_labels_path = "/Users/edoardochiavazza/Desktop/unito-scpd/adaboost-mpi/datasets/covertype.test.labels.csv";
